return {
	...
	ANNOUNCE_CHARLIE = "What? Ghosts?!?!",
	ANNOUNCE_CHARLIE_ATTACK = "I'm bleeding! No wait I'm only bones...",
	...
	DESCRIBE =
	{
		...
		COLDFIRE =
		{
			...
			NORMAL = "Chills me right to the bone.",
			OUT = "Even deader than me.",
		},
		CAMPFIRE =
		{
			EMBERS = "I should put something on the fire before it goes out.",
			...
			HIGH = "That fire is getting out of hand!",
			LOW = "The fire's getting a bit low.",
			NORMAL = "Warms me right to the bone.",
			OUT = "Even deader than me.",
		},
		...
		SAPLING =
		{
			...
			GENERIC = "Those sticks look awfully boney.",
		...
		SKELETON = "Old dry bones... Just like me!",
		SKELETON_PLAYER = "These look awfully familiar",
		...
		SUNKEN_BOAT_TRINKET_2 = "Now all I need is a miniaturaization machine!", --toy boat
